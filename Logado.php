...
.material-icons {
  ...
  font-feature-settings: 'liga';
	...
	<?php
			...
			//jogos
			$Conteudo = ' select ancTitulo,ancDesc,ancCodigo from anuncio  where ancCod_Categoria=4 and ancCod_Criador != '.$_SESSION['Login'].' and trocado = 0 order by ancCodigo desc limit 4';
